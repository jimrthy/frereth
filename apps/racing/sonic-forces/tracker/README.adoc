...
It started life as a copy/paste of the fulcro3 template. Have
converted much of its underlying technology with the aim of bending it
around to tech that I think I want to focus on for the web app
interaction portions of frereth.
...
Short version:
Ignore all those previous instructions. Open one of the .cljs buffers.
...
The rest of these instructions seem obsolete.
Or possibly just broken for new projects.
It just opened a REPL.

Went to localhost:9630 to enable my main build.
